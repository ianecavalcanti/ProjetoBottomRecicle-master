...
//                .build();
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Toast.makeText(LoginActivity.this, "Usuário Conectado.",Toast.LENGTH_SHORT).show();

                } else {
                    Toast.makeText(LoginActivity.this, "Usuário Desconectado",
        ...
        if (auth.getCurrentUser() != null) {
            startActivity(new Intent(LoginActivity.this, ActivityFour.class));
            finish();
        }
                        ...
                        .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    Intent goNavigation = new  Intent(getApplicationContext(), ActivityFour.class);
                                    goNavigation.putExtra("User", userLog);
                                    startActivity(goNavigation);
